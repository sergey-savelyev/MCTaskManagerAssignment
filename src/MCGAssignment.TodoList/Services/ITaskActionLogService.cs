...
public interface ITaskActionLogService
{
    ...
    Task<IEnumerable<LogEntryView>> GetTaskActionLogBatchByTaskAsync(string taskId, int skip, int take, string orderBy, bool descending, CancellationToken cancellationToken);
}